...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { flickr_id: @gallery.flickr_id, gallery_description: @gallery.gallery_description, gallery_name: @gallery.gallery_name }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { flickr_id: @gallery.flickr_id, gallery_description: @gallery.gallery_description, gallery_name: @gallery.gallery_name }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
