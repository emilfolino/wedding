...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { name: @gift.name, url: @gift.url, user_id: @gift.user_id, wedding_id: @gift.wedding_id }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { name: @gift.name, url: @gift.url, user_id: @gift.user_id, wedding_id: @gift.wedding_id }
    assert_redirected_to gift_path(assigns(:gift))
  end
